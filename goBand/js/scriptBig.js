...
logo.onload=function(){
	context.drawImage(logo,300,350,100,100);
	writeFont("李烨")
	drawChessBoard();
}
//输出字的函数
var writeFont=function(str){
	context.font='bold 100px consolas';
	context.textAlign='left';
	context.textBaseline='top';
	context.fillStyle='#B9B9B9';
	context.fillText(str,400,350);
}
//给棋盘绑定点击函数
...
var oneStep=function(i,j,me){
	...
	context.arc(30+i*60,30+j*60,25,0,2*Math.PI); //画弧度
	context.closePath();	//关闭路径

	//创建一个渐变对象，先是画两个圆
	var gradient=context.createRadialGradient(30+i*60+2,30+j*60+2,25,30+i*60-3,30+j*60-3,0);
	if(me){
